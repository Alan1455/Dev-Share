...
const Login = () => {
  ...
  if (loading) return <div className="h-screen flex items-center justify-center text-white/20 font-mono italic animate-pulse">正在建立安全連接...</div>;
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-white/5 p-4 rounded-2xl border border-white/5 text-left">
                <p className="text-[10px] uppercase text-white/30 font-black mb-1 tracking-widest">User Level</p>
              ...
              <div className="bg-white/5 p-4 rounded-2xl border border-white/5 text-left">
                <p className="text-[10px] uppercase text-white/30 font-black mb-1 tracking-widest">Max Capacity</p>
                <p className="text-white font-bold font-mono">
                  {liveProfile?.level === 'premium' ? '100000' : '5000'} Chars
                </p>
              </div>
            </div>
